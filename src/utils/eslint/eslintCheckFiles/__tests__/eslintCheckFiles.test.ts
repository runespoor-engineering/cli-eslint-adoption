...
describe("eslintCheckFiles", () => {
	...
	it("should resolve when no files found", async () => {
		...
		expect(
			eslintCheckFilePathsModule.eslintCheckFilePaths,
	...
	it("should use custom rootDir", async () => {
		...
		await expect(
			eslintCheckFiles({ rootDir: customRootDir }),
	...
	it("should use custom filesRegex", async () => {
		...
		await expect(
			eslintCheckFiles({ filesRegex: customRegex }),
		).resolves.toBeUndefined();
	...
	it("should handle multiple regex patterns", async () => {
		...
		await expect(
			eslintCheckFiles({ filesRegex: multipleRegex }),
		).resolves.toBeUndefined();
	...
	it("should handle empty results from getDeepFilesFromDir", async () => {
		...
		await expect(
			eslintCheckFiles({ rootDir: "/empty/dir" }),
		).resolves.toBeUndefined();
